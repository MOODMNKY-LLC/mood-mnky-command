...
2. **pfSense Unbound (LAN):** Host overrides **`media`** and **`media-request`** under **`moodmnky.com` → `10.0.0.25`** (avoid hairpin), same idea as **`netbird.moodmnky.com`** in **`mnky-docs/docs/infra/edge-network/pfsense.mdx`**.
