      ...
      <Card className="main-glass-panel-card w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            {needsConfirmation && (
              <div className="rounded-md border border-primary/50 bg-primary/10 px-3 py-2 text-sm text-foreground">
                Check your email to confirm your account. After confirming,{" "}
                <Link href="/auth/login" className="underline">sign in</Link> to create your organization.
              </div>
            )}
            {error && (
