      ...
      <VerseLogoFlame
        className={cn(
          ...
          isBg
            ...
            : isBand
              ? "-mb-0.5 max-h-[80px] w-[64px] text-current md:max-h-[100px] md:w-[80px] lg:max-h-[120px] lg:w-[96px]"
      ...
      <h1
        className={cn(
          ...
          isBg
            ...
            : isBand
              ? "text-lg tracking-[0.08em] text-current md:text-xl lg:text-2xl"
      ...
      <p
        className={cn(
          ...
          isBg
            ...
            : isBand
              ? "mt-0.5 text-[10px] tracking-[0.18em] text-current/75 md:text-xs lg:text-sm"
