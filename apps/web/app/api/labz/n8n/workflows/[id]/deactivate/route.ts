...
import { getN8nConfig, deactivateWorkflow, N8nApiError } from "@/lib/n8n/client"
...
> {
  ...
  try {
    ...
    console.error("[n8n/deactivate requireAdmin]", err)
...
export async function POST(
  ...
  try {
    const workflow = await deactivateWorkflow(config, id)
