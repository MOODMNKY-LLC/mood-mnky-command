...
export default async function DojoHomePage() {
  ...
  try {
    ...
    console.error("Dojo home fetch error:", e);
  }
      ...
      <BlurFade delay={0.1} inView inViewMargin="-20px">
        <section>
          <div className="mb-4 flex items-center justify-between">
            ...
            >
              <Link href="/dojo/products">View all</Link>
            </Button>
          </div>
          {products.length > 0 ? (
          ...
          <section>
            <div className="mb-4 flex items-center justify-between">
              ...
              <Button
                ...
                className="text-verse-text"
              >
                <Link href="/dojo/collections">View all</Link>
              </Button>
            </div>
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
              {collectionsList.map((col) => (
                <Link key={col.handle} href={`/dojo/collections/${col.handle}`}>
