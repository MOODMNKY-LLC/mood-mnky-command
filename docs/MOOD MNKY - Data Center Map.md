# MOOD MNKY: Data Center Map

A first-principles map of the MOOD MNKY Proxmox cluster: nodes, hardware, capabilities, and running VMs and LXCs. Intended for SRE and DevOps and for brand-coherent documentation.
...
|-----------|--------|
| **Status** | Offline |
| **Role** | Additional node; specs to be captured when online |
| **CPU** | — |
| **Memory** | — |
| **Root storage** | — |

**VMs and LXCs:** Not applicable until node is online. When MOOD-MNKY is brought up, run the hardware snapshot collector and add a row to this map.
...
Used for ISOs, LXC templates, snippets, and scripts across the cluster.
...
*Full documentation: [MOOD MNKY Homelab (Notion)](https://www.notion.so/324cd2a65422812d8f59fd69cf2666c7). See also [mnky-docs Data Center](https://docs.moodmnky.com) and [MOOD MNKY: Data Center (Upgrade Plan)](./MOOD%20MNKY%20-%20Data%20Center%20(Upgrade%20Plan).md).*
