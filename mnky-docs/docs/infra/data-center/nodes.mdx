...
| STUD-MNKY   | Online  | AMD Ryzen 7 5700G (Radeon)  | 8 / 16          | 62 GiB       | ~445 GiB              | STUD-zfs, local-zfs, local, hyper-mnky-shared (NFS)                  |
| PRO-MNKY    | Offline | (captured when online)      | —               | —            | —                     | (to be filled when node is online)                                   |
