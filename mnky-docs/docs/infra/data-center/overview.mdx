...
- [VLAN subnets and identity](/docs/infra/data-center/vlan-subnets-and-identity) – segment roles (DATA, MOOD, SAGE, CODE, CASA) and trust or exposure model
- [Cluster nodes](/docs/infra/data-center/nodes) – node profiles
- [CODE-MNKY node](/docs/infra/data-center/code-mnky-node) – CODE-MNKY hardware deep dive
- [CASA-MNKY node](/docs/infra/data-center/casa-mnky-node) – CASA-MNKY hardware deep dive
- [DATA-MNKY node](/docs/infra/data-center/data-mnky-node) – DATA-MNKY hardware deep dive
- [SAGE-MNKY node](/docs/infra/data-center/sage-mnky-node) – SAGE-MNKY hardware deep dive
- [MNKY-HQ node](/docs/infra/data-center/mnky-hq-node) – MNKY-HQ standalone networking Proxmox deep dive
- [Storage and network topology](/docs/infra/data-center/storage-and-network) – storage and network topology
- [Runbooks](/docs/infra/data-center/runbooks) – operational runbooks

## Network segments (VLAN identity)

Each cluster hypervisor sits on a **site /24** behind **pfSense**; remote access uses **NetBird** to the hub peer. For the canonical map of CIDRs, management IPs, intent (DATA core vs MOOD public plane vs CODE automation, and so on), and example anchors, read [VLAN subnets and identity](/docs/infra/data-center/vlan-subnets-and-identity).
...
| ----------- | ------------------------------------------------- | -------------------------- | --------------- | ------------ | -------- |
| CODE-MNKY   | Primary GPU host; LXCs 300/301/3001 + VMs 3055–3056 (live) | AMD Ryzen 5 4600G          | 6 / 12          | 125 GiB      | Online  |
...
| MOOD-MNKY    | Media stack (LXC 120), Intel iGPU / VA-API        | Intel Core i9-13900KS      | —               | ~125 GiB     | Online  |

Core characteristics:

- **Hypervisor**: Proxmox VE 8.4.17, kernel `6.8.12-19-pve`, EFI boot, Secure Boot disabled.
- **Workloads** (see [Data Center Map](/docs/infra/data-center/data-center-map) and [CODE-MNKY LXC inventory](/docs/infra/data-center/code-mnky-lxc-inventory)):
