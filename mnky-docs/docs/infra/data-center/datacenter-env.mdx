...
**Related topology:** [CODE-MNKY LXC inventory](/docs/infra/data-center/code-mnky-lxc-inventory) (live LXCs 300/301/3001 vs VMs 3055/3056); [VLAN subnets and identity](/docs/infra/data-center/vlan-subnets-and-identity) (which `datacenter.env` blocks map to which site /24).
...
Map `datacenter.env` key groups to **site CIDRs** (full narrative: [VLAN subnets and identity](/docs/infra/data-center/vlan-subnets-and-identity)):
...
- **Overlay:** `NETBIRD_*` (management URL, API, setup tokens) applies to all peers; routing semantics are in [NetBird](/docs/infra/edge-network/netbird).
