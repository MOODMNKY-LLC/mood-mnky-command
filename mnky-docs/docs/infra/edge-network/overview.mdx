...
For **workload and trust semantics** per /24 (DATA core vs MOOD public plane vs CODE automation, example anchors, and NetBird context), see [VLAN subnets and identity](/docs/infra/data-center/vlan-subnets-and-identity).
...
flowchart TB
  ...
  subgraph lan [OnPremRFC1918]
    ...
    m["10.1.0.0/24"]
    s["10.2.0.0/24"]
    codeVlan["10.3.0.0/24"]
    casaVlan["10.4.0.0/24"]
  end
  laptop --> cgNAT
  cgNAT --> wt0
  wt0 --> vt1
...
<CardGroup cols={2}>
  ...
  <Card title="VLAN subnets and identity" icon="map" href="/docs/infra/data-center/vlan-subnets-and-identity">
    Segment roles, management IPs, and exposure model per site /24.
  </Card>
</CardGroup>
