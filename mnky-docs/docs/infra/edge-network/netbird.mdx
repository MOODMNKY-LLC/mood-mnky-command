...
- Media workloads (Jellyfin/*arr), MOOD-MNKY LXC NetBird peer, and **LAN / overlay URLs** (Jellyfin + qBittorrent): [Media Stack](/docs/infra/data-center/media-stack) (see **Access hostnames**)
