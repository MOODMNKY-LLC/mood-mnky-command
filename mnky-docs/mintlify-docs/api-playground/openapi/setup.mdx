...
```
![OpenAPI autogeneration with tabs navigation example](/images/autogeneration-with-tabs.png)
...
![MindsDB OpenAPI page example showing custom MDX page structure](/images/mindsdb.png)
