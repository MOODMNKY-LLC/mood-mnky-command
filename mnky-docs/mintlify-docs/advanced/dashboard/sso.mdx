    ...
    <Tab title="SAML">
        <Steps>
            <Step title="Create an application">
                ...
                <Frame>
                    ![G Suite add custom SAML app configuration dialog](/images/gsuite-add-custom-saml-app.png)
                </Frame>              
            </Step>
            <Step title="Send us your IdP information">
                Copy the provided SSO URL, Entity ID, and x509 certificate and send it to the Mintlify team.
                <Frame>
                    ![G Suite SAML metadata configuration page](/images/gsuite-saml-metadata.png)                    
                </Frame>
            </Step>
            <Step title="Configure integration">
                ...
                * Name ID: `Basic Information > Primary email`
                ...
                <Frame>
                    ![G Suite service provider details configuration](/images/gsuite-sp-details.png)
                </Frame>
