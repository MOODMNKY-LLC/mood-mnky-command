...
<Steps>
  <Step title="Creating new branches">
    ...
    <Frame>
      <img src="/images/editor/branches-light.png" className="block dark:hidden" alt="Branches modal in light mode showing available git branches" />

      <img src="/images/editor/branches-dark.png" className="hidden dark:block" alt="Branches modal in dark mode showing available git branches" />
    </Frame>
    ...
    <Frame>
      <img src="/images/editor/new-branch-light.png" className="block dark:hidden" alt="New branch creation dialog in light mode" />

      <img src="/images/editor/new-branch-dark.png" className="hidden dark:block" alt="New branch creation dialog in dark mode" />
    </Frame>
  ...
  <Step title="Making a commit">
    ...
    <Tabs>
      <Tab title="Main branch">
        ...
        <Frame>
          <img src="/images/editor/publish-button-light.png" className="block dark:hidden" alt="Publish button in light mode for committing changes to main branch" />

          <img src="/images/editor/publish-button-dark.png" className="hidden dark:block" alt="Publish button in dark mode for committing changes to main branch" />
        </Frame>
      </Tab>
      ...
      <Tab title="Different branch">
        ...
        <Frame>
          <img src="/images/editor/pull-request-button-light.png" className="block dark:hidden" alt="Pull request button in light mode for creating pull requests" />

          <img src="/images/editor/pull-request-button-dark.png" className="hidden dark:block" alt="Pull request button in dark mode for creating pull requests" />
        </Frame>
      </Tab>
    </Tabs>
  ...
  <Step title="Making a pull request">
    ...
    <Frame>
      <img src="/images/editor/pr-modal-light.png" className="block dark:hidden" alt="Pull request modal in light mode for editing PR title and description" />

      <img src="/images/editor/pr-modal-dark.png" className="hidden dark:block" alt="Pull request modal in dark mode for editing PR title and description" />
    </Frame>
  </Step>
</Steps>
...
<Frame>
  <img src="/images/editor/slash-commands-light.png" className="block dark:hidden" alt="Slash commands menu in light mode showing available content blocks" />

  <img src="/images/editor/slash-commands-dark.png" className="hidden dark:block" alt="Slash commands menu in dark mode showing available content blocks" />
</Frame>

As you type, you'll see more options pop up:

<Frame caption="Command filtering">
  <img src="/images/editor/slash-commands-text-light.png" className="block dark:hidden" alt="Slash commands menu filtered by text input in light mode" />

  <img src="/images/editor/slash-commands-text-dark.png" className="hidden dark:block" alt="Slash commands menu filtered by text input in dark mode" />
</Frame>
...
<Frame>
  <img src="/images/editor/images-light.png" className="block dark:hidden" alt="Image selection modal in light mode showing upload and existing image options" />

  <img src="/images/editor/images-dark.png" className="hidden dark:block" alt="Image selection modal in dark mode showing upload and existing image options" />
</Frame>

Uploading an image can be done through the modal:

<Frame>
  <img src="/images/editor/upload-light.png" className="block dark:hidden" alt="Image upload interface in light mode" />

  <img src="/images/editor/upload-dark.png" className="hidden dark:block" alt="Image upload interface in dark mode" />
</Frame>

And you can preview an existing image before you add it.

<Frame>
  <img src="/images/editor/image-preview-light.png" className="block dark:hidden" alt="Image preview dialog in light mode showing image before adding to page" />

  <img src="/images/editor/image-preview-dark.png" className="hidden dark:block" alt="Image preview dialog in dark mode showing image before adding to page" />
</Frame>
...
<Frame>
  <img src="/images/editor/edit-image-light.png" className="block dark:hidden" alt="Image editing interface in light mode with delete and edit buttons visible" />

  <img src="/images/editor/edit-image-dark.png" className="hidden dark:block" alt="Image editing interface in dark mode with delete and edit buttons visible" />
</Frame>

Clicking the **"Edit"** button lets you edit the attributes of the image.

<Frame>
  <img src="/images/editor/image-form-light.png" className="block dark:hidden" alt="Image attributes form in light mode for editing image properties" />

  <img src="/images/editor/image-form-dark.png" className="hidden dark:block" alt="Image attributes form in dark mode for editing image properties" />
</Frame>
...
<Frame caption="View mode toggle">
  <img className="block dark:hidden" src="/images/editor/mode-toggle-light.png" alt="Editor mode toggle in light mode showing Visual, Source, and Diff view options" />

  <img className="hidden dark:block" src="/images/editor/mode-toggle-dark.png" alt="Editor mode toggle in dark mode showing Visual, Source, and Diff view options" />
</Frame>
