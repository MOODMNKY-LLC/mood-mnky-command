...
![Speakeasy source spec configuration interface](/images/speakeasy-1.webp)

Add the overlay created by Speakeasy to inject code snippets into your spec.

![Speakeasy overlay configuration for code snippet injection](/images/speakeasy-2.webp)

Provide a name and path for the OpenAPI spec. This will be the final spec used by Mintlify.

![Speakeasy OpenAPI spec naming and path configuration](/images/speakeasy-3.webp)
