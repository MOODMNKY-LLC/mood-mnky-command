...
<Frame>
  <img className="block dark:hidden rounded-md" src="/images/tabs-light.png" alt="Navigation tabs example in light mode showing horizontal tab navigation" />

  <img className="hidden dark:block rounded-md" src="/images/tabs-dark.png" alt="Navigation tabs example in dark mode showing horizontal tab navigation" />
</Frame>
...
<Frame>
  <img className="block dark:hidden rounded-md" src="/images/anchor-light.png" alt="Global anchors configuration in light mode showing external link anchors" />

  <img className="hidden dark:block rounded-md" src="/images/anchor-dark.png" alt="Global anchors configuration in dark mode showing external link anchors" />
</Frame>
...
<Frame>
  <img className="block rounded-md" src="/images/topbar-links.png" alt="Topbar links configuration showing custom links in documentation header" />
</Frame>
...
<Frame>
  <img className="block rounded-md" src="/images/topbar-cta-get-started.png" alt="Topbar call-to-action button configuration with Get Started button example" />
</Frame>
...
<Frame>
  <img className="block rounded-md" src="/images/topbar-cta-github.png" alt="Topbar call-to-action button configuration with GitHub button example" />
</Frame>
```json
"navbar": {
  "primary": {
