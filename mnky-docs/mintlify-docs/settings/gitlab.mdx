...
<Steps>
  <Step title="Find your project ID">
    ...
    <Frame>
      <img src="/images/gitlab/gitlab-project-id.png" alt="GitLab project settings page showing Project ID location" />
    </Frame>
  </Step>
  <Step title="Generate an access token">
    ...
    <Frame>
      <img src="/images/gitlab/gitlab-project-access-token.png" alt="GitLab access token creation form with Mintlify token configuration" />
    </Frame>
  ...
  <Step title="Set up the connection">
    ...
    <Frame>
      <img src="/images/gitlab/gitlab-config.png" alt="Mintlify dashboard Git settings page with GitLab project ID and access token fields" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Navigate to Settings > Webhooks and click 'Add new Webhook'">
    <Frame>
      <img src="/images/gitlab/gitlab-webhook.png" alt="GitLab webhooks settings page showing webhook configuration options" />
    </Frame>
  </Step>
  ...
  <Step title="Paste token">
    ...
    <Frame>
      <img src="/images/gitlab/gitlab-show-webtoken.png" alt="Mintlify dashboard displaying webhook token for GitLab configuration" />
    </Frame>
  </Step>
  <Step title="Select events">
    ...
    <Frame>
      <img src="/images/gitlab/gitlab-project-webtoken.png" alt="GitLab webhook configuration form with URL, token, and event selections" />
    </Frame>
  </Step>
  <Step title="Test the Webhook">
    ...
    <Frame>
      <img src="/images/gitlab/gitlab-project-webtoken-test.png" alt="GitLab webhook test results showing successful HTTP 200 response" />
    </Frame>
