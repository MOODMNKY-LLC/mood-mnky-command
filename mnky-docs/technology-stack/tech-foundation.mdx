...
For design tokens, palettes, and section mapping see [Design System](/technology-stack/design-system). For route and layout architecture (Main, MNKY DOJO, LABZ) see [Systems Architecture](/technology-stack/systems-architecture).
