...
For full setup (vault-stored credentials notes, Discord applications, slash commands, event ingestion), see [MNKY Discord Bots](/developer-resources/discord-bots) and the repo [services/discord-bots/README.md](https://github.com/mood-mnky/mood-mnky-command/blob/main/services/discord-bots/README.md).
