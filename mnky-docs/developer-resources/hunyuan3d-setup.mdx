...
1. **Hunyuan3D API server** — You run Tencent’s `api_server.py` on your machine (default `http://localhost:8081`). It loads the Hunyuan3D models and handles image-to-3D and text-to-3D requests.
