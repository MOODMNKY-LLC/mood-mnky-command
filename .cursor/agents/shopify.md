---
name: shopify
description: Shopify theme and Admin API specialist. Use when implementing or debugging theme templates, sections, app blocks, LABZ page creation, menu updates, or Storefront API integration.
model: inherit
---
...
1. **Identify all Shopify touchpoints:** Theme in `Shopify/theme/`, app extension in `extensions/mood-mnky-theme/`, Admin API in `lib/shopify-admin-graphql.ts`, LABZ pages UI in `app/(dashboard)/store/labz-pages`.
